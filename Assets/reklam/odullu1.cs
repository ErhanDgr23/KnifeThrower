...
public class odullu1 : MonoBehaviour {

    public static odullu1 instancee;
    ...
    {
        if (but == null)
            but = menumanager.menumanagersc.buttonfailed;
